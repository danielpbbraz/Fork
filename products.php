...
<!-- Header --><body>
  ...
  <main class="content">
    <div class="header-list-page">
      ...
      <a href="addProduct.php" class="btn-action">Adicionar novo produto</a>
    </div>
    <table class="data-grid">
      ...
      <?php
          while($user_data = mysqli_fetch_assoc($result))
          {
            ...
            echo "<td class='data-grid-td'>". $user_data['nameProduct']."</td>";
            echo "<td class='data-grid-td'>". $user_data['sku']."</td>";
            echo "<td class='data-grid-td'>". $user_data['price']."</td>";
            echo "<td class='data-grid-td'>". $user_data['quantity']."</td>";
            echo "<td class='data-grid-td'>". $user_data['category']."</td>";
            echo "<td class='data-grid-td'>"."</td>";
            echo "</tr>";
          }
