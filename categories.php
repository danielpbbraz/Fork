...
//Requisição das categorias em ordem de ID
...
<!-- Header --><body>
  ...
  <main class="content">
    ...
    <table class="data-grid">
      ...
      <!--       Faz a listagem das categorias cadastradas -->
      <?php
          while($user_data = mysqli_fetch_assoc($result))
          {
                echo "<tr class='data-row'>";
                echo "<td class='data-grid-td'>". $user_data['nameCategory']."</td>";
                echo "<td class='data-grid-td'>". $user_data['codeCategory']."</td>";
