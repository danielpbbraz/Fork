<?php
   ...
   if(isset($_POST['submit']))
   {
      ...
      // Teste de conexão com o banco de dados local
      // print_r($_POST['category-name']);
      // print_r('<br>');
      // print_r($_POST['category-code']);

      include_once('config.php');

      $nameCategory = $_POST['category-name'];
      $codeCategory = $_POST['category-code'];

      $result = mysqli_query($conexao, "INSERT INTO category(nameCategory, codeCategory) VALUES ('$nameCategory', '$codeCategory')");
   }
  ...
  <main class="content">
    ...
    <form action="addCategory.php" method="POST">
      ...
      <div class="actions-form">
        ...
        <input class="btn-submit btn-action" type="submit" name="submit" id="submit" value="Save" />
      </div>
    </form>
  </main>
  <!-- Main Content -->
